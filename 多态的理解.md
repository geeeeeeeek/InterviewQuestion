...
<img src='data/jvm-structure.png' width=400 height=400/>
虚方法表在类加载的连接阶段进行初始化，存放着各个方法的实际入口地址，如果某个方法在子类中没有被重写，那么子类的虚方法表中该方法的入口地址和父类保持一致。
<img src='data/method-object.png' width=400 height=400/>
<img src='data/method-pylomor.png' width=400 height=400/>
